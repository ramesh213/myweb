    ...
    >
      ...
      <div className="w-full">
        <div className="w-full h-[580px] justify-between flex">
          ...
          {
                errormsg && ((<p className="text-orange-300 ml-10 text-md font-bold">{errormsg}</p>))
              }
            <form action="" className="w-full h-full flex gap-3 p-8  flex-col">
              ...
              <div className="w-full gap-4">
                <p>Your Message</p>
                <textarea onChange={(e) => setMessage(e.target.value)} value={message} className="w-full h-40 hover:shadow hover:shadow-red-300 hover:focus-visible: row-span-10 rounded-lg border-b-[1px] border-b-gray-600 bg-slate-800 text-gray-400 py-2 px-3 outline-none resize-none "></textarea>
              </div>
              <div className="w-[20%]">
                <button
                  onClick={handleClick}
